...
The most recent release is [fluent-assertions 0.3][current release], released 2018-02-26.
...
[current release]: https://github.com/toberkoe/fluent-assertions/releases/tag/0.3
